...
import { AvisoPrivacidadModal } from "../../components/AvisoPrivacidadModal.js";
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-3">
              ...
              <label className="flex items-start gap-2 text-white/80 text-xs text-left cursor-pointer">
                ...
                <button
                  ...
                  className="underline font-semibold hover:text-white transition-colors hover:cursor-pointer"
                >
                  aviso de privacidad
                </button>.
              </label>
